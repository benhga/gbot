...
Please say \"Hi\" to try again."
        ...
        # out = "We are unfortunately experiencing problems with our airtime provider. To ensure that you receive your reward, we ask that you please wait for our invitation to complete the November survey."
        resp.message(out)
