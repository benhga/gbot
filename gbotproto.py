...
def bot():
    ...
    with io.open('response.csv','a', encoding = 'utf-8') as f1:
        ...
        if 'about' in incoming_msg:
            msg.body(Dictionary['aboutgenesis'])
...
# def contact(msg, incoming_msg):
#     msg.body(Dictionary['contact'])


# def covid(msg, incoming_msg):
#     msg.body(Dictionary['covid'])

#     if (incoming_msg == 1) or (incoming_msg == 'isafricaflatteningthecurve'):
#         out = Dictionary['isafricaflatteningthecurve']
#     elif (incoming_msg == 2) or (incoming_msg == 'healthcareriskcalculator'):
#         out = Dictionary['isafricaflatteningthecurve']
#     elif (incoming_msg == 3) or ('covidnews' in incoming_msg):
#         covnews = news_scrape('https://www.genesis-analytics.com/covid19', 3)
#         out = Dictionary['covidnews']
#         for x, y in covnews.items():
#             headline = "*" + x + "*\n"
